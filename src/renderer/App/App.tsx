  ...
  return (
    <div className="App">
      <div className="container">
        <img src={reactLogo.default} className="App-logo" alt="react-logo" id="react-logo" />
        <a
          className="App-link"
      ...
      <div className="container">
        <img src={tsLogo.default} className="App-logo" alt="typescript-logo" id="typescript-logo" />
        <a
          className="App-link"
